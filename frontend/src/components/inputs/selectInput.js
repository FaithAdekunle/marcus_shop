  ...
  return (
    <div class="relative mt-2">
      <button
        ...
        class="cursor-pointer grid w-full grid-cols-1 rounded-md py-1.5 pl-3 pr-2 text-left text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-gray-900 sm:text-sm/6 bg-gray-50"
      >
